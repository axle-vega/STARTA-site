...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заявка с сайта RusDT',
		'title' => 'Заявка с сайта RusDT',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'info@rusdt.com',
		'from_name' => 'RusDT',
		'to_email' => 'web@starta.ru',
		'to_name' => 'web',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заявка на обратный звонок с сайта RusDT',
		'title' => 'Заявка на обратный звонок с сайта RusDT',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'info@rusdt.com',
		'from_name' => 'RusDT',
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
    ...
    if(count($error) == 0) {
      ...
      if($mail) {
          $jsonBox['ok'] = 1;
          if(isset($form['cfg']['redirect'])) {
            $info[] = $form['cfg']['redirect'];
            } else {
            $info[] = $form['cfg']['okay'];
            }
